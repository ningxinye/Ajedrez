...
public:
	...
	friend bool operator ==(Casilla& cas1, Casilla& cas2);// La sobrecarga del operador de comparacion tambien solo declara
	...
	Casilla operator/(double num) const; // division por un escalar
